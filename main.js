...
function handleButtonClick(e) {
    ...
    if (formValidate()) {
        ...
        message.style.display = "block";
        message.innerHTML = `Formulário válido! enviado com sucesso! O valor A: ${numberA.value} Menor que B: ${numberB.value}`;
        ...
        message.style.display = "block";
        message.innerHTML = "Formulário invalido! O valor em A deve ser menor que o valor em B.";
        button.disabled = true;
